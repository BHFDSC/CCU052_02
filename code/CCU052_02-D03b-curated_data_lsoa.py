...
# MAGIC %md # CCU052_02-D03b-curated_data_lsoa
# MAGIC
# MAGIC **Description** This notebook creates the LSOA to region lookup table and LSOA to IMD lookup table. 
# MAGIC
...
# MAGIC
# MAGIC **Data input** dss_corporate.ons_chd_geo_listings, dss_corporate.english_indices_of_dep_v02
# MAGIC
# MAGIC **Data output** cur_lsoa_region, cur_lsoa_imd
