...
use  "\CCU052\aeasthma_data", clear 
...
save  "\CCU052\Final_rates\crude_aeasthma_by_imd", replace 

export delimited month_year  overall_numerator overall_denom IMD_2019_DECILES rate_est rate_se rate_lb rate_ub  using  "\CCU052\Final_rates\crude_aeasthma_by_imd.csv" , datafmt replace 
...
save  "\CCU052\Final_rates\crude_aeasthma_by_ethnic", replace 

export delimited month_year  overall_numerator overall_denom ethnicity rate_est rate_se rate_lb rate_ub  using  "\CCU052\Final_rates\crude_aeasthma_by_ethnic.csv" , datafmt replace 
...
save  "\CCU052\Final_rates\crude_aeasthma_by_region", replace 

export delimited month_year  overall_numerator overall_denom region rate_est rate_se rate_lb rate_ub  using  "\CCU052\Final_rates\crude_aeasthma_by_region.csv" , datafmt replace 
...
merge m:1 sex age_group using "\CCU052\age_sex_weights.dta"
drop _m
...
save  "\CCU052\Final_rates\adj_aeasthma_by_imd", replace 

export delimited month_year IMD_2019_DECILES rate_est rate_lb rate_ub using  "\CCU052\Final_rates\adj_aeasthma_by_imd.csv" , datafmt replace 
...
save  "\CCU052\Final_rates\adj_aeasthma_by_ethnic", replace 

export delimited month_year ethnicity rate_est rate_lb rate_ub using  "\CCU052\Final_rates\adj_aeasthma_by_ethnic.csv" , datafmt replace 
...
save  "\CCU052\Final_rates\adj_aeasthma_by_region", replace 

export delimited month_year region rate_est rate_lb rate_ub using  "\CCU052\Final_rates\adj_aeasthma_by_region.csv" , datafmt replace 
...
export delimited month_year overall_numerator overall_denom rate_est rate_se rate_lb rate_ub  using  "\CCU052\Final_rates\crude_aeasthma_rates.csv" , datafmt replace 

save  "\CCU052\Final_rates\crude_aeasthma_rates", replace 
...
save  "\CCU052\Final_rates\adj_aeasthma_rates", replace 

export delimited month_year  rate_est rate_lb rate_ub using  "\CCU052\Final_rates\adj_aeasthma_rates.csv" , datafmt replace 
...
save  "\CCU052\Final_rates\crude_aeasthma_by_sex_", replace 

export delimited month_year SEX overall_numerator overall_denom rate_est rate_se rate_lb rate_ub  using  "\CCU052\Final_rates\crude_aeasthma_by_sex.csv" , datafmt replace 
...
save  "\CCU052\Final_rates\adj_aeasthma_by_sex", replace 

export delimited month_year sex rate_est rate_lb rate_ub using  "\CCU052\Final_rates\adj_aeasthma_by_sex.csv" , datafmt replace 
...
save  "\CCU052\Final_rates\crude_aeasthma_by_age", replace 

export delimited month_year overall_numerator overall_denom age_group rate_est rate_se rate_lb rate_ub  using  "\CCU052\Final_rates\crude_aeasthma_by_age.csv" , datafmt replace 
...
save  "\CCU052\Final_rates\adj_aeasthma_by_age", replace 

export delimited month_year age_group rate_est rate_lb rate_ub using  "\CCU052\Final_rates\adj_aeasthma_by_age.csv" , datafmt replace 
